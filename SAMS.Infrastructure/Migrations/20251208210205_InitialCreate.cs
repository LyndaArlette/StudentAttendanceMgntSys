...
namespace SAMS.Infrastructure.Migrations
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_QRSessions_Classes_ClassId",
                        column: x => x.ClassId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StudentClassEnrollments", x => new { x.StudentId, x.ClassId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StudentLatitude = table.Column<double>(type: "float", nullable: true),
                    StudentLongitude = table.Column<double>(type: "float", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Attendances_QRSessions_QRSessionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Attendances_QRSessionId",
                table: "Attendances",
                column: "QRSessionId");
